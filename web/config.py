...
class Config(object):  
  ...
  # Stripe
  STRIPE_PUBLIC_KEY = "pk_test_51MhbMxEjwufTTBFVQJOlCpY6RqsBYdWAjZu6WGCglJh2gmMDfmlxGHyvmniz4La35gxaEaWOniJUAWfiaGh2Whzq009AoCPqGm"
  STRIPE_SECRET_KEY = "sk_test_51MhbMxEjwufTTBFVpMBgEx6kzwJ3MRWvSHptLFHB0QXc2zYZDbUvLoRrKwO5tHBhheQBHlDfv0CU2BCNu7T9F0Qb00YXroYIrC"
  STRIPE_PRICE_ID = "price_1MhbOmEjwufTTBFVXGhEXFoy"
  ...
  # AWS SNS topics
  AWS_SNS_JOB_REQUEST_TOPIC = "arn:aws:sns:us-east-1:127134666975:dramaswamy_a17_job_requests"
  AWS_SNS_THAW_TOPIC = "arn:aws:sns:us-east-1:127134666975:dramaswamy_a17_thaw"

  # AWS SQS queues
  AWS_SQS_REQUESTS_QUEUE_NAME = "dramaswamy_a17_job_requests"
  AWS_SQS_ARCHIVE_QUEUE_NAME = "dramaswamy_a17_archive"
